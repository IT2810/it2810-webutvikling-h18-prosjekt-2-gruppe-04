        ...
        return (
            <div className="sidebar" style={{width: (this.state.isNavClosed && this.state.smallScreen) ? "0" : "20rem"}}>
                <div className="sidebar-radio-wrapper">
                    ...
                    <CustomRadioButton title={"Hund"} group={"audio"} value={"dog"} defaultChecked={true} onChange={this.props.onChange} />
                    <CustomRadioButton title={"Katt"} group={"audio"} value={"cat"} onChange={this.props.onChange} />
                    <CustomRadioButton title={"Rev"} group={"audio"} value={"fox"} onChange={this.props.onChange} />
                </div>
